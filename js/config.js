export const config = {
  1: {
    ...
    alchemy_api: 'https://eth-mainnet.g.alchemy.com/v2/dWFr-jH_8JRHHbTL6peK-6qCO4w5ZdMn9/getNFTs/',
  ...
  4: {
    ...
    alchemy_api: 'https://eth-mainnet.g.alchemy.com/v2/WFr-jH_8JRHHbTL6peK-6qCO4w5ZdMn9/getNFTs/',
