...
console.log("Items fetched for migration address:", v2);
 ...
 if (v1) {
  ...
  v1.forEach(async (e) => {
    ...
    const url = `${config[chainId].opensea_api}/api/v2/chain/ethereum/contract/${config[chainId].origin_address}/nfts/${Web3.utils.toBN(e)}`;
...
const imageContainer = document.createElement('a');
  ...
  image.crossOrigin = 'Access-Control-Allow-Origin'//'anonymous';
